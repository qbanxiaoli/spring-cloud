...
@Setter
@Entity
@Table(appliesTo = "file", comment = "文件存储表")
@ApiModel(value = "文件存储模型")
public class File extends GmtEntity {

    @Column(nullable = false, length = 30, columnDefinition = "varchar(30) COMMENT '文件服务器访问地址'")
    ...
    @Column(nullable = false, columnDefinition = "bigint unsigned COMMENT '文件大小'")
